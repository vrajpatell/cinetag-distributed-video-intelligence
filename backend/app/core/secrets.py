...
def _load_from_secret_manager(secret_name: str) -> str | None:
...
def preload_known_secrets(secret_names: Iterable[str] = ('DATABASE_PASSWORD', 'OPENAI_API_KEY', 'APP_SECRET_KEY', 'JWT_SECRET')) -> None:
